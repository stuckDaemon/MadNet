...
import (
	dkg "github.com/MadBase/MadNet/layer1/executor/tasks/dkg/tests"
...
func TestCompletion_Group_1_AllGood(t *testing.T) {
	n := 4
	_, err := dkg.BuildTestEnvironment(t, n)
	assert.Nil(t, err)
	suite := dkg.StartFromMPKSubmissionPhase(t, n, 100)
