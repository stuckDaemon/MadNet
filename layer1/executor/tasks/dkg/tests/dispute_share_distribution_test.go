...
//import (
//	"context"
//	dkg2 "github.com/MadBase/MadNet/layer1/executor/tasks/dkg/tests"
...
//	n := 5
//	suite := dkg2.StartFromShareDistributionPhase(t, n, []int{}, []int{}, 100)
...
//	n := 5
//	suite := dkg2.StartFromRegistrationOpenPhase(t, n, 0, 100)
//	defer suite.Eth.Close()
//	accounts := suite.Eth.GetKnownAccounts()
//	ctx := context.Background()
//
...
//	dkg2.AdvanceTo(t, suite.Eth, nextPhaseAt)
//
//	// Do Share Dispute task
//	for idx := 0; idx < n; idx++ {
//		state := suite.DKGStates[idx]
...
//	n := 4
//	ecdsaPrivateKeys, _ := dkg2.InitializePrivateKeysAndAccounts(n)
//	logger := logging.GetLogger("ethereum")
//	logger.SetLevel(logrus.DebugLevel)
//	eth := dkg2.ConnectSimulatorEndpoint(t, ecdsaPrivateKeys, 333*time.Millisecond)
//	defer eth.Close()
//
...
//	n := 5
//	suite := dkgdkg2.StartFromShareDistributionPhase(t, n, []int{}, []int{}, 100)
//	defer suite.Eth.Close()
//	ctx := context.Background()
//	logger := logging.GetLogger("test").WithField("Validator", "")
//
